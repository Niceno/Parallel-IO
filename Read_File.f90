...
!------------------------------------------------------------------------------!
  integer                       :: i, j, var, error, file_handle, new_type
  real                          :: r_buff(N_CELL_SUB)
  integer(kind=MPI_OFFSET_KIND) :: disp
  integer                       :: offset, curr_offset
  character(len=TEXT_SIZE)      :: curr_var_name
!------------------------------------------------------------------------------!
